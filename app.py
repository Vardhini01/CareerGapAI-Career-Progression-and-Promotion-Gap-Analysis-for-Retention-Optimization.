...
st.markdown(
    ...
    [data-testid="stSidebar"] {
        background: var(--sidebar-bg); color: #000000; padding: 20px 18px; border-right: 1px solid #efe6dd;
    }
    [data-testid="stSidebar"] * {
...
def main() -> None:
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown("<div style='margin-bottom:10px; color:#000000; font-size:0.95rem; font-weight:700;'>Navigation</div>", unsafe_allow_html=True)
